...
(function() {
    ...
    function addToQuotation(product) {
        ...
        if (existingItem) {
            ...
            console.log('Item quantity increased in quotation - NO WhatsApp opened');
            return existingItem.quantity;
        }
        ...
        // ABSOLUTELY NO WHATSAPP OPENING - EVER!
    ...
    function showQuotationCart() {
        ...
        // Add quotation cart styles
        const quotationStyles = document.createElement('style');
        quotationStyles.id = 'quotation-cart-styles';
        quotationStyles.textContent = `
            .quotation-sidebar {
                position: fixed;
                top: 0;
                right: -400px;
        ...
        document.head.appendChild(quotationStyles);
        ...
        const closeQuotationCart = () => {
            ...
            setTimeout(() => {
                ...
                if (document.head.contains(quotationStyles)) document.head.removeChild(quotationStyles);
            }, 300);
        };
    ...
    function requestAllQuotes() {
        ...
        // Only open WhatsApp when user explicitly clicks "Request All Quotes" button
    ...
    function initializeCombinedSystem() {
        ...
        // Setup quotation cart button event listener
        const quotationButton = document.getElementById('quotation-cart-button');
        if (quotationButton) {
